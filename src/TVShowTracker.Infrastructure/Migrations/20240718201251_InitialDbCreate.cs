        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TMDbShowId = table.Column<int>(type: "int", nullable: false),
                    ...
                    Popularity = table.Column<double>(type: "float(10)", precision: 10, scale: 3, nullable: false),
                    PosterPath = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TMDbSeasonId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchedEpisodes_UserId",
                table: "WatchedEpisodes",
                column: "UserId");
        }
